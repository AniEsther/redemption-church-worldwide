...
const MINISTRIES = [
  { name: "Children's Ministry", description: 'Nurturing young hearts in the knowledge and love of Christ.' },
  { name: 'Youth Ministry', description: 'Raising a bold, Spirit-filled generation for kingdom purpose.' },
  { name: "Women's Ministry", description: 'Building women of faith, virtue and prayerful strength.' },
  { name: "Men's Ministry", description: 'Equipping men to lead with integrity in home, church and society.' },
  { name: 'Choir', description: 'Ministering in song and leading the congregation into worship.' },
  { name: 'Evangelism Team', description: 'Carrying the Gospel beyond our walls into the community.' },
  { name: 'Prayer Ministry', description: 'Standing in the gap through fervent, effectual prayer.' },
]
...
async function run() {
  ...
  await seedIfEmpty(Sermon, SERMONS, 'Sermons')
